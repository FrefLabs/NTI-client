 ...
 * Es una "tarjeta" del CardLayout principal.
 * Recibe instancias de Registro, Accion y Lectura.
 */
public class PanelJuego extends JPanel {
    ...
    public PanelJuego(Registro registro, Accion accion, Lectura lectura) { // (MODIFICADO)
        this.registro = registro;
        this.accion = accion;
        this.lectura = lectura; // (NUEVO)
    ...
    private JPanel crearPanelDerechoDividido() {
        ...
        JPanel panelRanking = crearPanelRanking(); // (MODIFICADO) Llama al método actualizado
    ...
    private JPanel crearPanelRanking() {
        ...
        // Pasa los JTextArea a las tarjetas
    ...
    // -------------------------------
    private JPanel crearTarjetaRanking(String titulo, JTextArea txtRanking) { // (MODIFICADO) Acepta JTextArea
        ...
        // Configura el JTextArea recibido
    ...
    private void actualizarRankings() {
        // Muestra "Actualizando..." inmediatamente
        txtRankingTyA.setText("Actualizando...");
        txtRankingEndless.setText("Actualizando...");

        // Crea un nuevo hilo para la llamada a la BD
        new Thread(() -> {
            // Esto se ejecuta en un hilo de fondo (NO CONGELA LA APP)
            ...
            if (endlessData != null && !endlessData.isEmpty()) {
                ...
                for (String[] fila : endlessData) {
                    // fila[0]=Nombre, fila[1]=Puntaje, fila[2]=Simbolo
            ...
            if (tyaData != null && !tyaData.isEmpty()) {
                ...
                for (String[] fila : tyaData) {
                    // fila[0]=Nombre, fila[1]=Ronda, fila[2]=Simbolo
